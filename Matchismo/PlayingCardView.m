...
#define DEFAULT_FACE_CARD_SCALE_FACTOR 0.78
...
#define CORNER_TEXT_FONT_SCALE 0.15
#define CORNER_TEXT_ORIGIN_OFFSET 2.0
- (void) drawCorners
{
    NSMutableParagraphStyle *paragraphStyle = [[NSMutableParagraphStyle alloc] init];
    paragraphStyle.alignment = NSTextAlignmentCenter;
    
    UIFont *cornerFont = [UIFont systemFontOfSize:self.bounds.size.width * CORNER_TEXT_FONT_SCALE];
    ...
    // top left corner
    CGRect textBounds;
    textBounds.origin = CGPointMake(CORNER_TEXT_ORIGIN_OFFSET, CORNER_TEXT_ORIGIN_OFFSET);
